...
base_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), "../../../../data/visualizations/function_bubbles/question_marks_null"))
...
script_name = 'function_bubbles_null'
...
hazard_score_mapping = {'A': 1, 'B': 0.9, 'C': 0.5, 'D': 0.1, 'F': 0.0, '?': None, 'U': None}
